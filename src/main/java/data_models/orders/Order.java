...
public abstract class Order {
    ...
    public BigDecimal getTotalOrderAmount() {
        ...
        for (Part part : orderedParts.keySet()) {
            orderAmount.add(part.getPricePerUnit().multiply(new BigDecimal(orderedParts.get(part))));
        }
        orderAmount.add(shippingFee);
        orderAmount.add(taxAmount);
        return orderAmount;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getOrderID(), order.getOrderID()) &&
                   Objects.equals(getInitiatingPerson(), order.getInitiatingPerson()) &&
                   Objects.equals(getOrderedParts(), order.getOrderedParts()) &&
                   Objects.equals(getOrderCreationDate(), order.getOrderCreationDate()) &&
                   Objects.equals(getShippingDate(), order.getShippingDate()) &&
                   Objects.equals(getShippingFee(), order.getShippingFee()) &&
                   Objects.equals(getTaxAmount(), order.getTaxAmount()) &&
                   Objects.equals(getTotalOrderAmount(), order.getTotalOrderAmount()) &&
