...
//            errorMsg = ex.getMessage() + "\nDatabase error. Parts list could not be loaded.";
//        }
//
...
// Hard-coding addresses, suppliers, parts, etc only because database not working
	...
	employee1 = Employee.createNew("Freeman", "Freddie", "f.freeman@autopartsstore.com", "6783411165",
        ...
        Supplier supplier1 = Supplier.createNew("Auto Parts Inc.", "770-564-2212", address1);
        Supplier supplier2 = Supplier.createNew("Steel Parts", "850-652-1111", address2);
        Supplier supplier3 = Supplier.createNew("Auto Parts Store", "850-652-1112", address1);
